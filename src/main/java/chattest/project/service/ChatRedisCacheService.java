...
import chattest.project.repo.ChatRepository;
...
import static chattest.project.repo.ChatRoomRepository.CHAT_SORTED_SET_;
...
public class ChatRedisCacheService {
    ...
    public String findUserNicknameByUsername(String username) {
        ...
        roomRedisTemplate.opsForHash().put(USERNAME_NICKNAME, username, member.getEmail());
